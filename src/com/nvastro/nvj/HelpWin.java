...
class HelpPane extends JEditorPane {
  ...
  public HelpPane(String url) {
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_HOME,
    		 InputEvent.CTRL_DOWN_MASK), "none");
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_END,
    		 InputEvent.CTRL_DOWN_MASK), "none");
...
class ScrollHelpPane extends NFScrollPane {
  ...
  protected void addKeyBindings() {
    ...
    copyKeyBinding(KeyEvent.VK_HOME,      InputEvent.CTRL_DOWN_MASK,
    		                                               source, target);
    copyKeyBinding(KeyEvent.VK_END,       InputEvent.CTRL_DOWN_MASK,
    		                                               source, target);
    copyKeyBinding(KeyEvent.VK_PAGE_UP,   InputEvent.CTRL_DOWN_MASK,
    		                                               source, target);
    copyKeyBinding(KeyEvent.VK_PAGE_DOWN, InputEvent.CTRL_DOWN_MASK,
    		                                               source, target);

    /* Create 2 new bindings */
    copyKeyBinding(KeyEvent.VK_PAGE_UP,   InputEvent.CTRL_DOWN_MASK, source,
                   KeyEvent.VK_LEFT,      InputEvent.CTRL_DOWN_MASK, target);
    copyKeyBinding(KeyEvent.VK_PAGE_DOWN, InputEvent.CTRL_DOWN_MASK, source,
                   KeyEvent.VK_RIGHT,     InputEvent.CTRL_DOWN_MASK, target);
  }
...
public class HelpWin extends JFrame {
   ...
   *
   * @param comp JComponent to remove key bindings
   */
  private void removeNavigationBindings(JComponent comp) {
    InputMap map =
   ...
   *
   * @param key Key
   * @param map InputMap to remove binding for key
   */
  private void removeKeyBinding(String key, InputMap map) {
