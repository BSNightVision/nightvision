...
public class Greek {
   ...
   * @return Name of Greek character (e.g. "Alpha")
   ...
   *
   * @param i Bounds: 1 &lt;= i &lt;= 24
   * @return Name of Greek character (e.g. "alpha") in lower case
   */
  static public String tellgreek(int i) {
    if ( i < 1 || i > 24 ) return "";
   ...
   * @return Upper case Greek unicode character
   */
   ...
   *
   * @param i Bounds: 1 &lt;= i &lt;= 24 (otherwise return blank)
   * @return Lower case Greek unicode character
   */
  static public char getgreek(int i) {
    if ( i < 1 || i > 24 ) return (char)' ';
