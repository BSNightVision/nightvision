...
public class Nvj extends JFrame implements ActionListener,
  ...
  /** Program version */
  static final public  String PgmVersion = "5.5";
  static final private String PgmInfo = "N i g h t   V i s i o n\n\n" +
                                        "Version " + PgmVersion + "\n\n" +
                                        "Copyright (C) B. Simpson 2026\n\n" +
  ...
  static final public String minjavareq = "1.8";
  ...
  /** Parent frame for popup dialogs (null results in minimize btn on dlg) */
  static public Component parentFrame = null;
  /** Working directory */
  ...
  private void addKeyBindings() {
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_UP,
             InputEvent.SHIFT_DOWN_MASK), "lineup");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_UP,
             InputEvent.CTRL_DOWN_MASK), "pageup");
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_PAGE_UP,
             InputEvent.SHIFT_DOWN_MASK), "pageup");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN,
             InputEvent.SHIFT_DOWN_MASK), "linedown");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN,
             InputEvent.CTRL_DOWN_MASK), "pagedown");
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_PAGE_DOWN,
             InputEvent.SHIFT_DOWN_MASK), "pagedown");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT,
             InputEvent.SHIFT_DOWN_MASK), "lineright");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT,
             InputEvent.CTRL_DOWN_MASK), "pageright");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT,
             InputEvent.SHIFT_DOWN_MASK), "lineleft");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT,
             InputEvent.CTRL_DOWN_MASK), "pageleft");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_C,
             InputEvent.CTRL_DOWN_MASK), "centerfld");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_1,
             InputEvent.CTRL_DOWN_MASK), "Ctrl1");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_2,
             InputEvent.CTRL_DOWN_MASK), "Ctrl2");
    ...
    //  }
    //});
    //imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_D, InputEvent.SHIFT_DOWN_MASK
    //         | InputEvent.CTRL_DOWN_MASK | Event.ALT_MASK), "LoadDS");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_J, InputEvent.SHIFT_DOWN_MASK |
             InputEvent.CTRL_DOWN_MASK | InputEvent.ALT_DOWN_MASK), "Julian");
    ...
    imap.put(KeyStroke.getKeyStroke(KeyEvent.VK_V, InputEvent.SHIFT_DOWN_MASK |
             InputEvent.CTRL_DOWN_MASK | InputEvent.ALT_DOWN_MASK), "Version");
  ...
  private static void setWorkingDir() {
    ...
    // The variable "query" will contain the Windows system request:
    ...
    query[0] = "reg";
    query[1] = "query";
    query[2] = "HKCU\\Software\\Microsoft\\Windows\\" +
               "CurrentVersion\\Explorer\\Shell Folders";
    query[3] = "/v";
    // query[4] will be "Personal" or "AppData"
    ...
    if ( os.toLowerCase().startsWith("windows") ) {
      ...
      if ( i >= 5 ) { // Windoze XP or higher
        try {
          ...
          // Target line in a typical response (Win 11):
          //     Personal    REG_SZ    C:\Users\<user>\OneDrive\Documents
          query[4] = "Personal";
          ...
          while ( (line = br.readLine()) != null ) {
            ...
            if ( words.length == 3 && words[0].equals(query[4]) ) {
              wdir = words[2];
              break;
            }
          }
  ...
  private static void time_bomb() {
    // int Year = 2019, Month = Calendar.JULY;
