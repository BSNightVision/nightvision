...
public class StarWin extends JComponent implements Printable, Runnable,
  ...
  public void mousePressed(MouseEvent e) {
    /* Popup button */
    if ( (e.getModifiersEx() & InputEvent.BUTTON3_DOWN_MASK) != 0 ) // Right btn
      mousePopup(e);

    /* Select button pressed */
    else if ( (e.getModifiersEx() & InputEvent.BUTTON1_DOWN_MASK) != 0 ) {//Left
  ...
  public void mouseReleased(MouseEvent e) {
    /* Popup button */
    if ( (e.getModifiersEx() & InputEvent.META_DOWN_MASK) != 0 ) // Right button
      mousePopup(e);

    /* Select button released */
    else if ( (e.getModifiersEx() & (InputEvent.SHIFT_DOWN_MASK |
    		InputEvent.CTRL_DOWN_MASK)) != 0 ) { // Left button (& Ctrl | Shift)
      if ( mouserect ) {
        mouserect = false;
